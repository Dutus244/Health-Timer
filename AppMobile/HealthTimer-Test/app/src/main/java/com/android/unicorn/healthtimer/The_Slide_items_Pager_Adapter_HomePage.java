...
public class The_Slide_items_Pager_Adapter_HomePage extends PagerAdapter {
    ...
    private List<The_Slide_Items_Model_Class_HomePage> theSlideItemsModelClassList;


    public The_Slide_items_Pager_Adapter_HomePage(Context Mcontext, List<The_Slide_Items_Model_Class_HomePage> theSlideItemsModelClassList) {
