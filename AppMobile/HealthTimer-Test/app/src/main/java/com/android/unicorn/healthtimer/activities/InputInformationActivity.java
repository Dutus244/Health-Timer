...
public class InputInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (name == null || name.equals("")) {
            ...
            Intent intent = new Intent(getApplicationContext(), BookingSearchActivity.class);
            startActivity(intent);
            finish();
        }

        setContentView(R.layout.activity_input_information);
        EditText inputfullname = findViewById(R.id.activity_input_information_input_fullname);
        EditText inputcitizenID = findViewById(R.id.activity_input_information_input_citizenID);
        EditText inputbirthday = findViewById(R.id.activity_input_information_input_birthday);

        EditText inputaddress = findViewById(R.id.activity_input_information_input_address);
        CheckBox checkBox = findViewById(R.id.activity_input_information_checkbox_rules);
        Button buttonConfirm = findViewById(R.id.activity_input_information_button_confirm);
        ...
        buttonConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String birth = temp[2] + "/" + temp[1] + "/" + temp[0];
                ...
                RequestQueue queue = Volley.newRequestQueue(InputInformationActivity.this);
