...
SQL_SERVER *dataServer = new SQL_SERVER(L"tcp:tntruong1009.database.windows.net",
...
{
  dataServer->Connect();
  // std::cout<<sv.Connect(L"tcp:tntruong1009.database.windows.net",
  //              L"DB20clc4_Test05-07_SieuTriTue",
  //              L"tntruong1009",
  //              L"Truong1009");

  WebResponse temp("localhost:8080", 80);
  temp.init();
  temp.run();
